...
MACRO(LINUX_DEPLOY_LIBRARY DIRNAME FILENAME)
    ...
    INSTALL(FILES GET_FILENAME_COMPONENT(${DIRNAME}/${FILENAME} REALPATH) DESTINATION lib RENAME ${FILENAME})
ENDMACRO()
...
MACRO(OS_X_DEPLOY_LIBRARY DIRNAME LIBRARY_NAME)
    ...
    ADD_CUSTOM_COMMAND(TARGET ${PROJECT_NAME} POST_BUILD
                       COMMAND ${CMAKE_COMMAND} -E copy GET_FILENAME_COMPONENT(${DIRNAME}/${LIBRARY_FILENAME} REALPATH)
                                                        ${LIBRARY_FILEPATH})
