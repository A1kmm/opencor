...
MACRO(LINUX_DEPLOY_LIBRARY DIRNAME FILENAME)
    ...
    GET_FILENAME_COMPONENT(LIB_REALPATH ${DIRNAME}/${FILENAME} REALPATH)
    INSTALL(FILES ${LIB_REALPATH} DESTINATION lib RENAME ${FILENAME})
ENDMACRO()
...
MACRO(OS_X_DEPLOY_LIBRARY DIRNAME LIBRARY_NAME)
    ...
    GET_FILENAME_COMPONENT(LIB_REALPATH ${DIRNAME}/${LIBRARY_FILENAME} REALPATH)
    ADD_CUSTOM_COMMAND(TARGET ${PROJECT_NAME} POST_BUILD
                       COMMAND ${CMAKE_COMMAND} -E copy ${LIB_REALPATH}
                                                        ${LIBRARY_FILEPATH})
